...
class Elements(ElementData, Enum):
    ...
    All functions defined for ``ElementData`` are accessible for members
    of this enum.
    ...
    Helium        = "He",    2,    4.002602,    18, {  4:  4.00260325413,  3:  3.0160293201}
    Lithium       = "Li",    3,    6.94,         1, {  7:  7.0160034366,   6:  6.0151228874}
    Beryllium     = "Be",    4,    9.0121831,    2, {  9:  9.012183065}
    Boron         = "B",     5,   10.81,        13, { 11: 11.00930536,    10: 10.01293695}
    Carbon        = "C",     6,   12.011,       14, { 12: 12.0,           13: 13.00335483507, 14: 14.0032419884}
    Nitrogen      = "N",     7,   14.007,       15, { 14: 14.00307400443, 15: 15.00010889888}
    Oxygen        = "O",     8,   15.999,       16, { 16: 15.99491461957, 18: 17.99915961286, 17: 16.9991317565}
    Fluorine      = "F",     9,   18.998403162, 17, { 19: 18.99840316273}
    Neon          = "Ne",   10,   20.1797,      18, { 20: 19.9924401762,  22: 21.991385114,   21: 20.993846685}
    Sodium        = "Na",   11,   22.98976928,   1, { 23: 22.989769282}
    Magnesium     = "Mg",   12,   24.305,        2, { 24: 23.985041697,   26: 25.982592968,   25: 24.985836976}
    ...
    Sulfur        = "S",    16,   32.06,        16, { 32: 31.9720711744,  34: 33.967867004,   33: 32.9714589098, 36: 35.96708071}
    Chlorine      = "Cl",   17,   35.45,        17, { 35: 34.968852682,   37: 36.965902602}
    Argon         = "Ar",   18,   39.95,        18, { 40: 39.9623831237,  36: 35.967545105,   38: 37.96273211}
    Potassium     = "K",    19,   39.0983,       1, { 39: 38.9637064864,  41: 40.9618252579,  40: 39.963998166}
    Calcium       = "Ca",   20,   40.078,        2, { 40: 39.962590863,   44: 43.95548156,    42: 41.95861783,   48: 47.95252276,  43: 42.95876644,  46: 45.953689}
    Scandium      = "Sc",   21,   44.955907,     3, { 45: 44.95590828}
    Titanium      = "Ti",   22,   47.867,        4, { 48: 47.94794198,    46: 45.95262772,    47: 46.95175879,   49: 48.94786568,  50: 49.94478689}
    Vanadium      = "V",    23,   50.9415,       5, { 51: 50.94395704,    50: 49.94715601}
    Chromium      = "Cr",   24,   51.9961,       6, { 52: 51.94050623,    53: 52.94064815,    50: 49.94604183,   54: 53.93887916}
    Manganese     = "Mn",   25,   54.938043,     7, { 55: 54.93804391}
    Iron          = "Fe",   26,   55.845,        8, { 56: 55.93493633,    54: 53.93960899,    57: 56.93539284,   58: 57.93327443}
    Cobalt        = "Co",   27,   58.933194,     9, { 59: 58.93319429}
    Nickel        = "Ni",   28,   58.6934,      10, { 58: 57.93534241,    60: 59.93078588,    62: 61.92834537,   61: 60.93105557,  64: 63.92796682}
    Copper        = "Cu",   29,   63.546,       11, { 63: 62.92959772,    65: 64.9277897}
    Zinc          = "Zn",   30,   65.38,        12, { 64: 63.92914201,    66: 65.92603381,    68: 67.92484455,   67: 66.92712775,  70: 69.9253192}
    Gallium       = "Ga",   31,   69.723,       13, { 69: 68.9255735,     71: 70.92470258}
    Germanium     = "Ge",   32,   72.630,       14, { 74: 73.921177761,   72: 71.922075826,   70: 69.92424875,   73: 72.923458956, 76: 75.921402726}
    Arsenic       = "As",   33,   74.921595,    15, { 75: 74.92159457}
    Selenium      = "Se",   34,   78.971,       16, { 80: 79.9165218,     78: 77.91730928,    76: 75.919213704,  82: 81.9166995,   77: 76.919914154, 74: 73.922475934}
    Bromine       = "Br",   35,   79.904,       17, { 79: 78.9183376,     81: 80.9162897}
    Krypton       = "Kr",   36,   83.798,       18, { 84: 83.9114977282,  86: 85.9106106269,  82: 81.91348273,   83: 82.91412716,  80: 79.91637808,  78: 77.92036494}
    Rubidium      = "Rb",   37,   85.4678,       1, { 85: 84.9117897379,  87: 86.909180531}
    Strontium     = "Sr",   38,   87.62,         2, { 88: 87.9056125,     86: 85.9092606,     87: 86.9088775,    84: 83.9134191}
    Yttrium       = "Y",    39,   88.905838,     3, { 89: 88.9058403}
    Zirconium     = "Zr",   40,   91.222,        4, { 90: 89.9046977,     94: 93.9063108,     92: 91.9050347,    91: 90.9056396,   96: 95.9082714}
    Niobium       = "Nb",   41,   92.90637,      5, { 93: 92.906373}
    Molybdenum    = "Mo",   42,   95.95,         6, { 98: 97.90540482,    96: 95.90467612,    95: 94.90583877,   92: 91.90680796, 100:99.9074718,    97: 96.90601812,   94: 93.9050849}
    Technetium    = "Tc",   43,   97.0,          7, { 97: 96.9063667,     98: 97.9072124,     99: 98.9062508}
    Ruthenium     = "Ru",   44,  101.07,         8, {102:101.9043441,    104:103.9054275,    101:100.9055769,    99: 98.9059341,  100:99.9042143,    96: 95.90759025,   98: 97.9052868}
    Rhodium       = "Rh",   45,  102.90549,      9, {103:102.905498}
    Palladium     = "Pd",   46,  106.42,        10, {106:105.9034804,    108:107.9038916,    105:104.9050796,   110:109.9051722,  104:103.9040305,   102:101.9056022}
    Silver        = "Ag",   47,  107.8682,      11, {107:106.9050916,    109:108.9047553}
    Cadmium       = "Cd",   48,  112.414,       12, {114:113.90336509,   112:111.90276287,   111:110.90418287,  110:109.90300661, 113:112.90440813,  116:115.90476315,  106:105.9064599, 108:107.9041834}
    Indium        = "In",   49,  114.818,       13, {115:114.903878776,  113:112.90406184}
    Tin           = "Sn",   50,  118.710,       14, {120:119.90220163,   118:117.90160657,   116:115.9017428,   119:118.90331117, 117:116.90295398,  124:123.9052766,   122:121.9034438, 112:111.90482387, 114:113.9027827, 115:114.903344699}
    Antimony      = "Sb",   51,  121.760,       15, {121:120.903812,     123:122.9042132}
    Tellurium     = "Te",   52,  127.60,        16, {130:129.906222748,  128:127.90446128,   126:125.9033109,   125:124.9044299,  124:123.9028171,   122:121.9030435,   123:122.9042698, 120:119.9040593}
    Iodine        = "I",    53,  126.90447,     17, {127:126.9044719}
    Xenon         = "Xe",   54,  131.293,       18, {132:131.9041550856, 129:128.9047808611, 131:130.90508406,  134:133.90539466, 136:135.907214484, 130:129.903509349, 128:127.903531,  124:123.905892,   126:125.9042983}
    Cesium        = "Cs",   55,  132.90545196,   1, {133:132.905451961}
    Barium        = "Ba",   56,  137.327,        2, {138:137.905247,     137:136.90582714,   136:135.90457573,  135:134.90568838, 134:133.90450818,  130:129.9063207,   132:131.9050611}
    Lanthanum     = "La",   57,  138.90547,      3, {139:138.9063563,    138:137.9071149}
    Cerium        = "Ce",   58,  140.116,        0, {140:139.9054431,    142:141.9092504,    138:137.905991,    136:135.90712921}
    Praseodymium  = "Pr",   59,  140.90766,      0, {141:140.9076576}
    Neodymium     = "Nd",   60,  144.242,        0, {142:141.907729,     144:143.910093,     146:145.9131226,   143:142.90982,    145:144.9125793,   148:147.9168993,   150:149.9209022}
    Promethium    = "Pm",   61,  145.0,          0, {145:144.9127559,    147:146.915145}
    Samarium      = "Sm",   62,  150.36,         0, {152:151.9197397,    154:153.9222169,    147:146.9149044,   149:148.9171921,  148:147.9148292,   150:149.9172829,   144:143.9120065}
    Europium      = "Eu",   63,  151.964,        0, {153:152.921238,     151:150.9198578}
    Gadolinium    = "Gd",   64,  157.249,        0, {158:157.9241123,    160:159.9270624,    156:155.9221312,   157:156.9239686,  155:154.9226305,   154:153.9208741,   152:151.9197995}
    Terbium       = "Tb",   65,  158.925354,     0, {159:158.9253547}
    Dysprosium    = "Dy",   66,  162.500,        0, {164:163.9291819,    162:161.9268056,    163:162.9287383,   161:160.9269405,  160:159.9252046,   158:157.9244159,   156:155.9242847}
    Holmium       = "Ho",   67,  164.930329,     0, {165:164.9303288}
    Erbium        = "Er",   68,  167.259,        0, {166:165.9302995,    168:167.9323767,    167:166.9320546,   170:169.9354702,  164:163.9292088,   162:161.9287884}
    Thulium       = "Tm",   69,  168.934219,     0, {169:168.9342179}
    Ytterbium     = "Yb",   70,  173.045,        0, {174:173.9388664,    172:171.9363859,    173:172.9382151,   171:170.9363302,  176:175.9425764,   170:169.9347664,   168:167.9338896}
    Lutetium      = "Lu",   71,  174.96669,      0, {175:174.9407752,    176:175.9426897}
    Hafnium       = "Hf",   72,  178.486,        4, {180:179.946557,     178:177.9437058,    177:176.9432277,   179:178.9458232,  176:175.9414076,   174:173.9400461}
    Tantalum      = "Ta",   73,  180.94788,      5, {181:180.9479958,    180:179.9474648}
    Tungsten      = "W",    74,  183.84,         6, {184:183.95093092,   186:185.9543628,    182:181.94820394,  183:182.95022275, 180:179.9467108}
    Rhenium       = "Re",   75,  186.207,        7, {187:186.9557501,    185:184.9529545}
    Osmium        = "Os",   76,  190.23,         8, {192:191.961477,     190:189.9584437,    189:188.9581442,   188:187.9558352,  187:186.9557474,   186:185.953835,    184:183.9524885}
    Iridium       = "Ir",   77,  192.217,        9, {193:192.9629216,    191:190.9605893}
    Platinum      = "Pt",   78,  195.084,       10, {195:194.9647917,    194:193.9626809,    196:195.96495209,  198:197.9678949,  192:191.9610387,   190:189.9599297}
    Gold          = "Au",   79,  196.966570,    11, {197:196.96656879}
    Mercury       = "Hg",   80,  200.592,       12, {202:201.9706434,    200:199.96832659,   199:198.96828064,  201:200.97030284, 198:197.9667686,   204:203.97349398,  196:195.9658326}
    Thallium      = "Tl",   81,  204.38,        13, {205:204.9744278,    203:202.9723446}
    Lead          = "Pb",   82,  207.2,         14, {208:207.9766525,    206:205.9744657,    207:206.9758973,   204:203.973044}
    ...
    Thorium       = "Th",   90,  232.0377,       0, {232:232.0380558,    230:230.0331341}
    Protactinium  = "Pa",   91,  231.03588,      0, {231:231.0358842}
    Uranium       = "U",    92,  238.02891,      0, {238:238.0507884,    235:235.0439301,    234:234.0409523,   233:233.0396355,  236:236.0455682}
